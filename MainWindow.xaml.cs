...
namespace DiskManager
{
    ...
    public partial class MainWindow : Window
    {
        ...
        void CreateAbout()
        {
            ...
            {
                Text = "This application was developed during a 48-hour Hackathon organised by Tally under the event CodeBrewers,23 ," +
           " showcasing rapid development skills. " +
           "The impressive project emerged victorious," +
           " highlighting the team's talent and " +
           "dedication to creating innovative solutions within a tight timeframe. ",
            ...
            {
                new Profile { Name = "Deepak Singh", Email = "deepaksingh171001@gmail.com", Position = "Frontend Dev" },
                new Profile { Name = "Mukul Rawat", Email = "mukulrawat24032001@gmail.com", Position = "Full Stack Dev" },
                new Profile { Name = "Shourya Srivastava", Email = "shouryasrivastava001@gmail.com", Position = "Full Stack Dev" }
            };
